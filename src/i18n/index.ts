  ...
  services: {
    ...
    automation: {
      ...
      steps: [
        ...
        { title: "Process Mapping", desc: "We document exactly what's done, by whom, and where things break down." },
        ...
        { title: "20h Free Support", desc: "Twenty hours of included support within two months — to tune what was built, answer questions, and make sure your team is fully confident." },
      ],
      benefits: [
