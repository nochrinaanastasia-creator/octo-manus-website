  ...
  it: {
    ...
    sections: [
      /* ── Supply Chain IT ── */
      {
        ...
        pains: [
          { title: "Incertezza della Domanda",         desc: "Vendite, stagionalità, promozioni e cambiamenti di mercato rendono difficile prevedere le scorte, la capacità o i rifornimenti necessari." },
          { title: "Sistemi Disconnessi e Controlli Manuali", desc: "ERP, strumenti di magazzino, portali dei corrieri, fogli di calcolo e caselle di posta spesso non comunicano tra loro. I team perdono tempo a controllare la stessa spedizione, lo stesso ordine o lo stesso movimento di stock in più posti." },
          { title: "Report Costruiti a Mano",            desc: "I report operativi richiedono spesso di esportare dati, pulire fogli di calcolo, controllare le eccezioni e preparare aggiornamenti manualmente — il che rallenta le decisioni e aumenta il rischio di errore." },
          { title: "Follow-Up Ripetitivi",               desc: "I team passano ore a inseguire conferme, ETA, informazioni mancanti, aggiornamenti sulle spedizioni e approvazioni operative che potrebbero essere automatizzate o pre-strutturate." },
        ],
        solutions: [
          { title: "Previsione della Domanda",           desc: "Modelli AI costruiti sui tuoi dati storici, pattern stagionali e lead time dei fornitori — per decisioni di acquisto con una base reale, non un'intuizione." },
          { title: "Allineamento dei Dati Operativi",   desc: "Workflow che connettono e strutturano i dati da ERP, file di magazzino, aggiornamenti dei corrieri, fogli di calcolo e strumenti interni — perché i team lavorino con informazioni più coerenti." },
          { title: "Reporting Automatizzato",            desc: "Sistemi di reportistica che raccolgono, puliscono e strutturano i dati operativi, così il tuo team passa meno tempo a costruire report manualmente e più tempo ad agire sui risultati." },
          { title: "Automazione del Follow-Up",          desc: "Workflow automatizzati che inseguono conferme, ETA, dettagli mancanti, aggiornamenti sulle spedizioni e approvazioni — così il tuo team spende meno tempo a chiedere due volte la stessa informazione." },
        ],
        insight: {
          hook:  "3–5",
  ...
  es: {
    ...
    sections: [
      /* ── Supply Chain ES ── */
      {
        ...
        pains: [
          { title: "Incertidumbre de la Demanda",         desc: "Las ventas, la estacionalidad, las promociones y los cambios de mercado hacen difícil predecir qué stock, capacidad o reposición se necesitará a continuación." },
          { title: "Sistemas Desconectados y Verificaciones Manuales", desc: "ERP, herramientas de almacén, portales de transportistas, hojas de cálculo y bandejas de entrada a menudo no se comunican entre sí. Los equipos pierden tiempo revisando el mismo envío, pedido o movimiento de stock en varios sitios." },
          { title: "Informes Construidos a Mano",          desc: "Los informes operativos suelen requerir exportar datos, limpiar hojas de cálculo, verificar excepciones y preparar actualizaciones manualmente, lo que ralentiza la toma de decisiones y aumenta el riesgo de error." },
          { title: "Seguimientos Repetitivos",              desc: "Los equipos pasan horas persiguiendo confirmaciones, ETAs, información faltante, actualizaciones de envíos y aprobaciones operativas que podrían automatizarse o pre-estructurarse." },
        ],
        solutions: [
          { title: "Previsión de Demanda",                    desc: "Modelos de IA construidos sobre tus datos históricos, patrones estacionales y plazos de entrega — para que tus decisiones de compra tengan una base real, no una corazonada." },
          { title: "Alineación de Datos Operativos",           desc: "Workflows que conectan y estructuran datos de ERPs, archivos de almacén, actualizaciones de transportistas, hojas de cálculo y herramientas internas — para que los equipos trabajen con información más consistente." },
          { title: "Informes Automatizados",                   desc: "Sistemas de reporting que recopilan, limpian y estructuran datos operativos, para que tu equipo pase menos tiempo construyendo informes manualmente y más tiempo actuando sobre los resultados." },
          { title: "Automatización del Seguimiento",           desc: "Workflows automatizados que persiguen confirmaciones, ETAs, detalles faltantes, actualizaciones de envíos y aprobaciones — para que tu equipo pierda menos tiempo pidiendo la misma información dos veces." },
        ],
        insight: {
          hook:  "3–5",
